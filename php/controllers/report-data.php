<?php
  ...
  $sql = "SELECT Книги.Название, Читатели.ФИО, Читатели.Телефон, Книговыдачи.Дата_выдачи, Книговыдачи.Дата_сдачи, IF (Экземпляры.Дата_утери IS NULL, DATEDIFF(Книговыдачи.Дата_сдачи, Книговыдачи.Дата_выдачи), NULL) as Число_дней, Экземпляры.Дата_утери, Причины_утерь_экземпляров.Описание FROM Книговыдачи
